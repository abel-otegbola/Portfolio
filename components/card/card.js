...
const Card = ({ project }) => {
    return (
        <div data-testid="card" className="my-10 border border-transparent p-2 bg-gray-300/[0.3] rounded dark:bg-slate-300/[0.02] border-y-slate-300/[0.1]" data-aos="fade-up">
            ...
            <div className="p-2">
                ...
                {/* Project summary */}
                <p className="leading-[30px]">{project.summary && project.summary.slice(0, 120) || project.description}...<Link href={`/project/?query=${project.title.toLowerCase()}`} className="text-fuchsia-300 hover:text-fuchsia-600">View more</Link></p>
