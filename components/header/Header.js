...
const Header = () => {
  return (
    <div className="p-6 rounded flex flex-col md:items-center bg-white dark:bg-[#000]/[0.2] md:shadow-lg md:mt-[2%] md:mx-[5%] lg:w-[300px] md:border border-gray-500/[0.1]">
