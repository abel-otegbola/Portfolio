...
const Header = () => {
  return (
    <div className="flex flex-wrap gap-4 w-full md:mt-[2%]">
      <div className="flex-1 p-6 rounded flex flex-col md:items-center bg-white dark:bg-gray-600/[0.05] md:shadow md:border border-gray-500/[0.2] dark:border-gray-500/[0.08]">
      ...
      <div className="flex flex-col gap-4 md:w-[65%] w-full py-5 rounded -leading-[20px] p-4" >
        <p className="p-4 bg-gray-600/[0.09]">Bio</p>
