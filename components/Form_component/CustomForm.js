    ...
    return (
        <form action="https://formilio.com/api/endpoint/57c1z43qvy" method="post">
            ...
            <label className="w-full flex flex-col">
                ...
                <textarea className="p-[12px] border border-slate-300/[0.3] rounded bg-transparent w-full" placeholder="e.g Your portfolio is really cool 🚀. Are you available to jump on a website development project? 😉" name='message' autoComplete="true" required></textarea>
            </label>
