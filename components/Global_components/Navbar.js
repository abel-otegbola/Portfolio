...
const Navbar = () => {
    ...
    return (
        <div className="flex items-center justify-between rounded mx-4 lg:mx-[10%] p-3 sticky top-4 left-0 backdrop-blur-sm bg-white/[0.05] z-10">
            ...
            <nav className={`lg:static fixed md:flex gap-4 right-0 top-0 lg:bg-transparent bg-body/[0.95] backdrop-blur-sm overflow-hidden transition-all duration-700 z-20 lg:h-[auto] h-screen ${open ? "lg:w-[auto] w-[100%]" : "lg:w-[auto] w-0"}`}>
