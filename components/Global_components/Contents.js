...
const Contents = () => {
    ...
    return (
        <div className="lg:p-16 p-4 lg:mt-6 lg:ml-6 lg:w-2/3 bg-gray-800/[0.2]">
            ...
            {/* SKILLS SECTION */}
            <h2 className="font-semibold text-2xl pb-6 pt-24 underline decoration-1 decoration-gray-500 underline-offset-8" id="skills" data-aos="fade-right">SKILLS</h2>
            <Skills />

            <hr className="mt-10 opacity-[0.5]" />

            {/* PORTFOLIO SECTION */}
            <h2 className="font-semibold text-2xl pb-6 pt-24 underline decoration-1 decoration-gray-500 underline-offset-8" data-aos="fade-right">PORTFOLIO</h2>
            <Projects />
            ...
            {/* CONTACT SECTION */}
            <h2 className="font-semibold text-2xl pb-6 pt-24 underline decoration-1 decoration-gray-500 underline-offset-8" id="contact" data-aos="fade-right">CONTACT ME</h2>
