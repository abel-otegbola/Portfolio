    ...
    <div className="">
      <header className="flex min-h-[88vh] items-center flex-wrap md:px-[6%] px-4">
        <div className="flex flex-col font-light">
          ...
          <h1 className="mt-4 flex flex-wrap items-center gap-4 md:text-[48px] text-[32px]">Hi! My Name is <span className="p-4 py-2 rounded-full border border-black text-black text-[24px] uppercase bg-secondary">Abel Otegbola</span></h1>
          ...
          <Button href="/contact" className="rounded-full items-center gap-4 pr-1 border border-black py-6 uppercase text-[14px] font-bold text-black">
            Let&apos;s chat
            <span className="h-[36px] w-[36px] bg-white rounded-full flex justify-center items-center border border-black"></span>
          </Button>
        ...
        <div className="md:absolute lg:flex items-end justify-center p-[5%] hidden top-0 right-0 w-[36%] h-[100%] bg-secondary dark:bg-secondary/[0.3]">
          <Button href="/contact" className="rounded-full items-center gap-4 pr-1 bg-transparent border border-black py-4 uppercase text-[14px] font-bold text-black">
            It takes more power to build 
            <span className="h-[30px] w-[30px] bg-white rounded-full flex justify-center items-center border border-black"></span>
          </Button>
        </div>
      </header>

      <section className="md:p-[6%] md:py-[10%] p-4 py-10 bg-black dark:bg-[#101010] text-white/[0.8] flex justify-between flex-wrap gap-8">
