...
export default function RootLayout({
  ...
  return (
    <html lang="en" className=" scroll-smooth ">
      <body
        className={`${SuisseIntl.className} antialiased md:text-[16px] text-[14px] text-[#000] bg-[#FFFFFF] dark:bg-[#181818] dark:text-white/[0.9] cursor-[url('/cursor.png'),_pointer]`}
      >
        <Header />
