export const projects = [
  ...
  },
  {
    ...
    title: "FlashLeads",
    description:
      "Built a simplified CRM experience for freelancers and small teams to manage leads and clients without the overhead of complex enterprise CRM tools.",
    features: [
      "Clean and focused dashboard",
      "Consistent, reusable UI components",
      "Simple flows for managing leads and clients",
      "Structured tables with filtering"
    ],
    howBuilding: [
      "Situation: Existing CRM tools are often bloated and overwhelming for freelancers and small agencies.",
      "Task: Build a lightweight CRM that prioritizes clarity, structure, and ease of use.",
      "Action: Designed intuitive dashboards and tables, implemented filtering and client flows, and built the frontend using Next.js, Tailwind, and shadcn/ui."
    ],
    links: {
      live: "https://flashleads.vercel.app",
      github: "",
      design: "",
    },
    images: [
  ...
  },
  {
    ...
    title: "Campuxmart",
    description:
      "Developed a campus-focused marketplace to connect student vendors and buyers, enabling secure and convenient peer-to-peer commerce within universities.",
    features: [
      "Product listing and browsing for student vendors",
      "Campus-centric categories and discovery",
      "Reviews and ratings for trust-building"
    ],
    howBuilding: [
      "Situation: Students lacked a trusted platform for buying and selling goods within campus environments.",
      "Task: Create a marketplace tailored to student needs and local campus commerce.",
      "Action: Conducted user research, designed a simple marketplace flow, and built the platform with a focus on usability, payments, and community trust features."
    ],
    links: {
