...
export default function Header() {
    ...
    return (
      <div className="sticky top-0 border border-dashed border-gray-500/[0.3] z-[50]  backdrop-blur-lg">
        <div className="flex items-center justify-between dark:text-gray dark:bg-black/[0.8] xl:mx-[25%] lg:mx-[20%] md:mx-[10%] md:py-1 md:px-3 py-3 px-4 border-x border-dashed border-gray-500/[0.3]">
            <Link href="/" className="">
