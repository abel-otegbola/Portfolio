  ...
  return (
    ...
    <div className='lg:px-[10%] px-4 flex lg:flex-nowrap flex-wrap'>
      ...
      <div className="lg:p-16 p-2 lg:mt-6 lg:ml-6 lg:w-2/3 md:dark:bg-black/[0.1] md:bg-gray-300/[0.2] overflow-hidden">
            ...
            {/* SKILLS SECTION */}
            <h2 className="text-primary font-semibold text-xl p-4 pb-6 pt-[50px]" id="skills" data-aos="fade-right">SKILLS</h2>
            <Skills />

            <hr className="mt-10 opacity-[0.5]" />

            {/* PORTFOLIO SECTION */}
            <h2 className="text-primary font-semibold text-xl p-4 pb-6 pt-[50px]" data-aos="fade-right">PORTFOLIO</h2>
            <Projects />
            ...
            {/* CONTACT SECTION */}
            <h2 className="text-primary font-semibold text-xl p-4 pb-6 pt-[50px]" id="contact" data-aos="fade-right">CONTACT ME</h2>
